<template>
  <b-container fluid id="blog-section" class="section blog-section">
    ...
    <b-row class=mb-5>
      <b-col>
        ...
        <b-row>
          <b-col>
            <b-card header-tag="h2" header="Title" title="Category" overlay img-src="https://picsum.photos/900/250/?image=3">
              <b-card-text>
